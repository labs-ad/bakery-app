---
name: file-creator
description: Use proactively to create files, directories, and apply templates for project workflows. Handles batch file creation with proper structure and boilerplate.
...
- Tasks: @docs/specs/[FOLDER]/tasks.md
- Technical Specification: @docs/specs/[FOLDER]/sub-specs/technical-spec.md
[ADDITIONAL_DOCS]
```
...
This is the technical specification for the spec detailed in @docs/specs/[FOLDER]/spec.md
...
This is the database schema implementation for the spec detailed in @docs/specs/[FOLDER]/spec.md
...
This is the API specification for the spec detailed in @docs/specs/[FOLDER]/spec.md
...
This is the tests coverage details for the spec detailed in @docs/specs/[FOLDER]/spec.md
...
These are the tasks to be completed for the spec detailed in @docs/specs/[FOLDER]/spec.md
...
### Single File Request
```
Create file: docs/specs/2025-01-29-auth/spec.md
...
Directory: docs/specs/2025-01-29-user-auth/
Files:
...
### Success
```
✓ Created directory: docs/specs/2025-01-29-user-auth/
